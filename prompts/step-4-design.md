...
2. Describe the end-to-end solution architecture: React Native screens/components, state management (e.g., Zustand/Redux/Recoil), native HealthKit bridge modules, data models, networking/LLM orchestration, Supabase persistence strategy, and background refreshes.
...
## Quality Bar
- Use precise React Native + TypeScript terminology (e.g., `useState`, `useEffect`, `useFocusEffect`, TurboModules, native bridges) and Swift/Objective-C specifics only when discussing Apple Health integration.
