...
- [ ] **Beta 5 — verify the crash is gone + share the tester link** once Apple finishes processing 1.0.3 (7). This build (not Beta 4) is the one to give testers, since it contains the crash fix. Confirm testers with real menstrual data no longer crash.
